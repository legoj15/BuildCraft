...
public class GuiElectronicLibrary extends AbstractContainerScreen<ContainerElectronicLibrary> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        for (int i = 0; i < list.size() && i < 12; i++) {
            ...
            if (isSelected) {
                guiGraphics.fill(listX, listY, listX + 154, listY + 8, 0xFF_55_55_55);
            }
            ...
            guiGraphics.drawString(font, text, listX, listY, colour, false);
            listY += 8;
        }
        ...
        if (progressDown >= 0) {
            ...
            guiGraphics.fill(leftPos + 194, topPos + 58,
        ...
        if (progressUp >= 0) {
            ...
            guiGraphics.fill(leftPos + 194, topPos + 79,
