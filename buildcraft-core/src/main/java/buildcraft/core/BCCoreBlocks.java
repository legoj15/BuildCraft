...
public class BCCoreBlocks {
    ...
    public static final DeferredBlock<Block> DECORATED_DESTROY = BLOCKS.registerSimpleBlock(
            "decorated_destroy", BlockBehaviour.Properties.of().strength(3.0f).sound(SoundType.METAL));

    public static final DeferredBlock<Block> DECORATED_BLUEPRINT = BLOCKS.registerSimpleBlock(
            "decorated_blueprint", BlockBehaviour.Properties.of().strength(3.0f).lightLevel(s -> 10).sound(SoundType.METAL));

    public static final DeferredBlock<Block> DECORATED_TEMPLATE = BLOCKS.registerSimpleBlock(
            "decorated_template", BlockBehaviour.Properties.of().strength(3.0f).lightLevel(s -> 10).sound(SoundType.METAL));

    public static final DeferredBlock<Block> DECORATED_PAPER = BLOCKS.registerSimpleBlock(
            "decorated_paper", BlockBehaviour.Properties.of().strength(3.0f).lightLevel(s -> 10).sound(SoundType.METAL));

    public static final DeferredBlock<Block> DECORATED_LEATHER = BLOCKS.registerSimpleBlock(
            "decorated_leather", BlockBehaviour.Properties.of().strength(3.0f).lightLevel(s -> 10).sound(SoundType.METAL));

    public static final DeferredBlock<Block> DECORATED_LASER = BLOCKS.registerSimpleBlock(
            "decorated_laser", BlockBehaviour.Properties.of().strength(3.0f).sound(SoundType.METAL));
    ...
    public static final DeferredBlock<BlockEngineRedstone_BC8> ENGINE_REDSTONE = BLOCKS.registerBlock(
            "engine_redstone",
            BlockEngineRedstone_BC8::new, BlockBehaviour.Properties.of().strength(3.0f).sound(SoundType.METAL));

    public static final DeferredBlock<BlockEngineCreative> ENGINE_CREATIVE = BLOCKS.registerBlock(
            "engine_creative",
            BlockEngineCreative::new, BlockBehaviour.Properties.of().strength(3.0f).sound(SoundType.METAL));
