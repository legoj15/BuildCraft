...
/**
 * Provides vanilla block paint handlers for blocks like stained glass and
 * terracotta.
 * Note: In 1.21, block types changed significantly. Dyeable blocks now use
 * DyeColor properties.
 */
public class VanillaPaintHandlers {
    ...
    public static void fmlInit() {
        ...
        // registerDoubleTypedHandler(Blocks.GLASS, Blocks.STAINED_GLASS,
        // StainedGlassBlock.COLOR);
        // registerDoubleTypedHandler(Blocks.GLASS_PANE, Blocks.STAINED_GLASS_PANE,
        // StainedGlassPaneBlock.COLOR);
        // registerDoubleTypedHandler(Blocks.TERRACOTTA, Blocks.TERRACOTTA,
        // TerracottaBlock.COLOR);
    }

    private static <T extends Comparable<T>> void registerDoubleTypedHandler(Block clear, Block dyed,
            Property<T> colourProp) {
    ...
    public static <T extends Comparable<T>> ICustomPaintHandler createDoubleTypedPainter(Block clear, Block dyed,
            Property<T> colourProp) {
