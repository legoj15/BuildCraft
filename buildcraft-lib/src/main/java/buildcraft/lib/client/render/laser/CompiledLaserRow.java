...
public class CompiledLaserRow {
    ...
    public void bakeStart(LaserContext context, double length) {
        ...
        context.addPoint(0, h, -h, texU(i), texV(0));
        context.addPoint(0, h, h, texU(i), texV(1));
        context.addPoint(l, h, h, texU(1), texV(1));
        context.addPoint(l, h, -h, texU(1), texV(0));
        // BOTTOM
        context.setFaceNormal(0, -1, 0);
        context.addPoint(l, -h, -h, texU(1), texV(0));
        context.addPoint(l, -h, h, texU(1), texV(1));
    ...
    public void bakeEnd(LaserContext context, double length) {
        ...
        // TOP
        context.setFaceNormal(0, 1, 0);
        context.addPoint(ls, h, -h, texU(0), texV(0));
        context.addPoint(ls, h, h, texU(0), texV(1));
        context.addPoint(lb, h, h, texU(i), texV(1));
        context.addPoint(lb, h, -h, texU(i), texV(0));
        // BOTTOM
        context.setFaceNormal(0, -1, 0);
        context.addPoint(lb, -h, -h, texU(i), texV(0));
        context.addPoint(lb, -h, h, texU(i), texV(1));
    ...
    public void bakeFor(LaserContext context, LaserSide side, double startX, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (side == LaserSide.TOP) {
                ...
                context.addPoint(ls, h, -h, texU(0), texV(0));
                context.addPoint(ls, h, h, texU(0), texV(1));
                context.addPoint(lb, h, h, texU(1), texV(1));
                context.addPoint(lb, h, -h, texU(1), texV(0));
