...
public class FacadeItemModel implements ItemModel {
    ...
    private static final LoadingCache<KeyPlugFacade, List<BakedQuad>> guiCache = CacheBuilder.newBuilder()
        ...
        .build(CacheLoader.from(key -> {
            ...
            for (MutableQuad quad : PlugBakerFacade.INSTANCE.bakeForKey(key)) {
                quad.vertex_0.translatef(0, 0, offsetZ); quad.vertex_0.lighti(15, 15);
                quad.vertex_1.translatef(0, 0, offsetZ); quad.vertex_1.lighti(15, 15);
                quad.vertex_2.translatef(0, 0, offsetZ); quad.vertex_2.lighti(15, 15);
                quad.vertex_3.translatef(0, 0, offsetZ); quad.vertex_3.lighti(15, 15);
                quads.add(quad.toBakedItem());
            }
            return quads;
        }));
