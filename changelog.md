...
- Fixed Forge Energy pipes not powering Applied Energistics 2's Energy Acceptor (and other bufferless FE receivers) — pipes now gauge how much power a block will actually accept rather than assuming it has an internal buffer to fill; a Wooden FE Pipe also no longer mistakes such a sink for a power source
