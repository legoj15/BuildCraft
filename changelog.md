...
- Fixed the FE pipe recipes never unlocking in the recipe book (broken item id in the unlock advancement)
- Pipes can now be dyed in the crafting grid (any number of one pipe type plus a dye), or bleached back to unpainted with a water bucket; pipes can also be crafted pre-dyed directly from stained glass
