...
public abstract class IntegrationRecipe {
    ...
    public IntegrationRecipe(IngredientStack name) {
        this.name = name;
    }
     ...
     * @param toIntegrate All available stacks to integrate (not all have to be used
     *                    up in this recipe)
     * @return The output to produce based on the inputs provided or an empty stack
     *         if the recipe isn't valid
     */
