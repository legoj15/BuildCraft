...
public interface IScriptableRegistry<E> extends IReloadableRegistry<E> {
     ...
     *         the resource domain's that had added entries to this registry through
     *         scripts. */
     ...
     * {@link IEntryDeserializer#deserialize(Object, JsonObject, JsonDeserializationContext)} will never be
     * disabled. */
    @FunctionalInterface
    public interface ISimpleEntryDeserializer<E> extends IEntryDeserializer<E> {

        /** Bridge method to {@link #deserializeConst(Object, JsonObject, JsonDeserializationContext)}.
         * <p>
         * NOTE: Callers are free to assume that this method is never overridden, and so are free to call
         * {@link #deserializeConst(Object, JsonObject, JsonDeserializationContext)} directly. */
        @Override
