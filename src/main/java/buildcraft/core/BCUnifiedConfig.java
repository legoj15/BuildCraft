 ...
 * Combines BCLibConfig, BCCoreConfig, BCTransportConfig, BCEnergyConfig, BCBuildersConfig, and
 * BCSiliconConfig into a single ModConfigSpec so there's one config file and one config button.
 *
...
public class BCUnifiedConfig {
    ...
    static {
        ...
        buildcraft.silicon.BCSiliconConfig.buildGeneral(builder);
        builder.pop();
