...
/**
 * Defines the visual style for different laser types used by the marker system,
 * quarry, builder, and other machines. Each laser type defines a textured beam
 * with cap, start, middle-variation, and end sections.
 */
