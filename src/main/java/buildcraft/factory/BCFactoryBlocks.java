...
public class BCFactoryBlocks {
    ...
    public static final DeferredBlock<BlockTank> TANK = BLOCKS.registerBlock(
            "tank",
            BlockTank::new,
            BlockBehaviour.Properties.of().strength(0.3f).noOcclusion().sound(SoundType.GLASS));

    public static final DeferredBlock<BlockTube> TUBE = BLOCKS.registerBlock(
            "tube",
            BlockTube::new,
            BlockBehaviour.Properties.of().destroyTime(-1.0f).noOcclusion().sound(SoundType.METAL));
