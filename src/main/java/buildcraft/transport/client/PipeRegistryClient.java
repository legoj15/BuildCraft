...
/** Client-side registry for pipe renderers. Maps flow/behaviour/pluggable classes
 *  to their dynamic renderers and static bakers. */
public enum PipeRegistryClient implements PipeApiClient.IClientRegistry {
    ...
    public <P extends PluggableModelKey> void registerBaker(Class<? extends P> keyClass,
        IPluggableStaticBaker<P> baker) {
        plugBakerMap.put(keyClass, baker);
    }
