...
public class BuildCraftGameTests {
    ...
    public static void onRegister(net.neoforged.neoforge.registries.RegisterEvent event) {
        if (event.getRegistryKey().equals(Registries.TEST_FUNCTION)) {
            ...
            event.register(Registries.TEST_FUNCTION, net.minecraft.resources.Identifier.parse("buildcraftunofficial:architect_wood_pipe_extracts"), () -> buildcraft.factory.MachinePipeConnectivityTester::testWoodPipeExtractsFinishedBlueprintFromArchitect);
            event.register(Registries.TEST_FUNCTION, net.minecraft.resources.Identifier.parse("buildcraftunofficial:architect_clay_pipe_inserts"), () -> buildcraft.factory.MachinePipeConnectivityTester::testClayPipeInsertsBlankBlueprintIntoArchitect);
