...
public class BuildCraftGameTests {
    ...
    public static void onRegister(net.neoforged.neoforge.registries.RegisterEvent event) {
        if (event.getRegistryKey().equals(Registries.TEST_FUNCTION)) {
            ...
            event.register(Registries.TEST_FUNCTION, net.minecraft.resources.Identifier.parse("buildcraftunofficial:fluidmode_clear_behaves_like_replace"), () -> buildcraft.builders.snapshot.FluidHandlingModeTester::testClearAtPlaceSiteBehavesLikeReplace);
