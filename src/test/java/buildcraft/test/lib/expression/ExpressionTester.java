...
public class ExpressionTester {
    ...
    public void testVariables() {
        ...
        Assertions.assertFalse(expBool.evaluate());
        variant.value = "gold";
        Assertions.assertTrue(expBool.evaluate());
        variant.value = "iron";
        Assertions.assertFalse(expBool.evaluate());
        ...
        variant.value = "wood";
        Assertions.assertEquals(expLong.evaluate(), 0);
        variant.value = "steel";
        Assertions.assertEquals(expLong.evaluate(), 1);
        variant.value = "obsidian";
        Assertions.assertEquals(expLong.evaluate(), 2);
        variant.value = "some_other_value";
        Assertions.assertEquals(expLong.evaluate(), 3);
    }
    ...
    private static void bakeAndCallDouble(String function, double expected, FunctionContext ctx) {
        ...
        Assertions.assertEquals(expected, got, 0.0001);
    }
