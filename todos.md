...
- [ ] Find the 24 game tests that silently skip on Minecraft 1.21.1 — [notes](docs/todo-details.md#skipped-game-tests-on-1211)
...
- [ ] Bring robots back — next: the robot entity itself — [plan](docs/robotics-resurrection.md)
